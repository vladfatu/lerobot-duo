...
AFRAME.registerComponent('websocket-panel', {
  ...
  createPanel: function() {
    ...
    this.panel.appendChild(background);
    
    // Title
    const title = document.createElement('a-text');
    title.setAttribute('value', 'WebSocket');
    title.setAttribute('align', 'center');
    title.setAttribute('position', `0 ${height * 0.32} 0.01`);
    ...
    this.statusIndicator.setAttribute('position', `${-width * 0.3} ${height * 0.05} 0.01`);
    ...
    this.statusText.setAttribute('position', `${-width * 0.2} ${height * 0.05} 0.01`);
    ...
    this.button.setAttribute('position', `0 ${-height * 0.25} 0.01`);
